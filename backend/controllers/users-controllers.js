...
const findUserWithEmail = async email => {
  ...
  try {
    ...
    return next(new Error('Could not find user with email: ', +error));
  }
  return user;
};
...
const signup = async (req, res, next) => {
  ...
  try {
    ...
    return next(new Error('Could not save user in DB: ' + error));
  }
...
const guest = async (req, res, next) => {
  ...
  try {
    ...
    return next(new Error('Could not save guest in DB: ' + error));
  }
...
const edit = async (req, res, next) => {
  ...
  const errors = validationResult(req);
  if (!errors.isEmpty()) {
    return next(new Error('Edit invalid entries: ' + error));
  }
  ...
  try {
    ...
    return next(new Error('Could not save user update: ' + error));
  }
